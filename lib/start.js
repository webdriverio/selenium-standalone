...
/**
 * @param {string[]} list params list
 * @param {*} param expected param
 * @returns {boolean}
 */
const hasParam = (list, param) => list.includes(param);

const start = async (_opts) => {
  ...
  checkPathsExistence(Object.keys(fsPaths).map((name) => fsPaths[name].installPath));
