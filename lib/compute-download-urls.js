...
function computeDownloadUrls(opts, askedOpts) {
  ...
  if (opts.drivers.edge) {
    downloadUrls.edge = util.format(
      urls.edge,
      opts.drivers.edge.baseURL,
      getEdgeDriverDirectory(opts.drivers.edge.version),
      getEdgeDriverExtension(opts.drivers.edge.version)
    );
  }
  return downloadUrls;
}
...
function getEdgeDriverDirectory(version) {
  var release = parseInt(version)
  switch (release) {
    case 15063:
      return '3/4/2/342316D7-EBE0-4F10-ABA2-AE8E0CDF36DD'
    case 14393:
      return '3/2/D/32D3E464-F2EF-490F-841B-05D53C848D15'
    case 10586:
      return 'C/0/7/C07EBF21-5305-4EC8-83B1-A6FCC8F93F45'
    case 10240:
      return '8/D/0/8D0D08CF-790D-4586-B726-C6469A9ED49C'
    default:
...
function getEdgeDriverExtension(version) {
  var release = parseInt(version)
  switch (release) {
    case 15063:
    case 14393:
