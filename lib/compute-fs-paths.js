...
const { validateMajarVersionPrefix } = require('./validation')
...
async function computeFsPaths(options) {
  ...
  if (opts.drivers.chrome) {
    ...
    if (opts.drivers.chrome.version !== 'latest' && Number(validateMajarVersionPrefix(opts.drivers.chrome.version)) > 114) {
    ...
    } else if (opts.drivers.chrome.version !== 'latest' && Number(validateMajarVersionPrefix(opts.drivers.chrome.version)) <= 114) {
