...
Currently installs selenium `2.43.1`, chrome driver `2.11` and internet explorer driver `2.43.0`. 32bit driver is preferred for internet explorer over 64 bit one. 64bit driver can be installed to x64 architecture environments by defining use64bitie environment variable.
